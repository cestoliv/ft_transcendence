		...
		<div className="ChanUser-wrapper">
			...
			>
				<Box className="chan-user-modal">
					{!isAdmin() && (
						<button name="button-add-admin" onClick={setAdmin}>
							Set Admin
						</button>
					)}
					{isAdmin() && (
						<button name="button-remove-admin" onClick={setAdmin}>
							Remove Admin
						</button>
					)}
					<button name="button-ban_user" onClick={banUser}>
						Ban
					</button>
					<button>Kick</button>
					<button name="button-mute_user" onClick={muteUser}>
						Mute
					</button>
				</Box>
			</Modal>
