  ...
  useEffect(() => {
    if (gameStarted && !gameEnd) { 
        const intervalId = setInterval(() => {
          ...
          //collide right
          if (ballSpeedX > 0 && ballX > (canvasWidth - 20) && ballX < (canvasWidth - 10) && ballY + ballSpeedY < rightRacketY + racketHeight  && ballY + ballSpeedY > rightRacketY) {
                // Change direction
                setBallSpeedX(-ballSpeedX);
                let impact = ballY - rightRacketY - racketHeight / 2;
                var ratio = 100 / (racketHeight / 2);
                ...
                // Increase speed if it has not reached max speed
                 ...
                 // colide left
          } else if (ballSpeedX < 0 && ballX < 20 && ballX > 10 && ballY + ballSpeedY < leftRacketY + racketHeight && ballY + ballSpeedY > leftRacketY) {
                // Change direction
                setBallSpeedX(ballSpeedX * -1);
                let impact = ballY - leftRacketY - racketHeight / 2;
                var ratio = 100 / (racketHeight / 2);
