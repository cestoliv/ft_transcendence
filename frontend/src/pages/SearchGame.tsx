    ...
    return (
        <div className="searchGame-wrapper">
            ...
            <div className="searchRandomPlayer">
                    <button className='searchRandomPlayer-button' onClick={handleOpen}>Search a game</button>
                    {renderRedirect()}
                    <Modal
                        open={open}
                        onClose={handleClose}
                    ...
                    >
                        <Box sx={style}>
                            <button className="redirect-button" onClick={handleRedirect}>redirect</button>
                        </Box>
                    </Modal>
                </div>
